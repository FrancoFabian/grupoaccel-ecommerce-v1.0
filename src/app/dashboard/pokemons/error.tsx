...
export default function Error({
  ...
  <div className="flex flex-col items-center justify-center">
    <p className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-wider text-gray-200 mt-8">
      500
    </p>
    <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-200 mt-2">
      Server Error
    </p>
    <p className="md:text-lg xl:text-xl text-gray-100 mt-4">
      {error.message}
    </p>
  </div>
</div>
